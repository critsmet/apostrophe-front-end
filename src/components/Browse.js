...
export default class Browse extends React.Component {
  render(){
    ...
    <div id="browser" className="flex justify-between avenir mt1 ttl ml5 mr5">
      <div className="f6 dib pt1 tl bg-washed-green tc br3 w-50 h3">
      ...
      <div className="flex dib f6 tl bg-washed-yellow br3 h3 w-50">
