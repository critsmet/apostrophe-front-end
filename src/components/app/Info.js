    ...
    <div className="flex flexbox flex-wrap justify-center w-100">
      ...
      <div className="flex mt4-ns mt3 w-100 w-30-l w-40-m ml3">
        <span className="info">
          ...
          if you would like to be part of the project, please send an e-mail to apostrophe@gmail.com with information about a publication you think belongs here.
          ...
          feel free to send a message if you are interested in joining the project.
        </span>
      </div>
    </div>
  )
