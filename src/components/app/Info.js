    ...
    <div className="flex flexbox flex-wrap justify-center w-100">
      ...
      <div className="flex mt4-ns mt3 w-100 w-30-l w-40-m ml3">
        <span className="info">
          ...
          despite how pervasive they are in contemporary culture, they remain undervalued content medium, perhaps because of the lack of an index to reference them.
